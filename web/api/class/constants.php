...
define('DATA_BASE_AVATAR_VERSION', 1527260134);
define('DATA_BASE_INFORMATION_VERSION', 1527260134);
define('DATA_BASE_UNIFORM_VERSION', 1527260134);
define('DATA_BASE_ACHIVIMENTS_VERSION', 1527260134);
define('DATA_BASE_CARDS_VERSION', 1527260134);
define('DATA_BASE_BANNER_VERSION', 1527260134);
define('DATA_BASE_HISTORY_VERSION', 1527260134);
